...
class RootRefresh {
    constructor( inRoot ) {
        ...
        this.createAlbum = ( inBackend, inArtist, inAlbumTitle, inIgnoreDuplicate, inUpdateLastModified ) => {
        ...
        this.createArtist = ( inBackend, inArtistTitle, inIgnoreDuplicate, inUpdateLastModified ) => {
            const theRootRefresh = this;
            return new Promise( function( inResolve, inReject ) {
                const theArtist =
        ...
        this.createTrack = ( inBackend, inBackendTrack ) => {
        ...
        this.refreshCreations = ( inBackend, inBackendTracks ) => {
        ...
        this.refreshDeletions = inBackendTracks => {
        ...
        this.updateTrack = ( inBackend, inBackendTrack, inTrack ) => {
